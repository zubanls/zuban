...
use zuban_db::diagnostic::Severity;
use zuban_db::source::{line_index, source_text};
...
impl BackgroundDocumentRequestHandler for DocumentDiagnosticRequestHandler {
    fn document_url(params: &DocumentDiagnosticParams) -> Cow<Uri> {
...
fn to_lsp_diagnostic(
    db: &dyn Db,
    diagnostic: &dyn zuban_db::diagnostic::Diagnostic,
