...
fn test_signature_param_position() {
    ...
    check_all![
        ...
        (code3, "h(a,b,c,", 2),
        (code3, "h(a,b,c,d", 2),
        // TODO (code3, "h(a,b,c,d[", 2),
        // TODO (code3, "h(a,b,c,(3,", 2),
        (code3, "h(a,b,c,(3,)", 2),
        ...
        // TODO (code3, "h(u,x=2,**y", 1),
        // TODO (code3, "h(u,v=2,**y", 3),
        // TODO (code3, "h(u,x=2,**vv", 1),
        // *args, **kwargs
        (code4, "i(a,b,c,d", 2),
        (code4, "i(a,b,c,d,e", 2),
        (code4, "i(a,b,c,d,e=", 5),
        (code4, "i(a,b,c,d,e=3", 5),
        // TODO (code4, "i(a,b,c,d=,x=", 3),
        (code4, "i(a,b,c,d=5,x=4", 3),
        // TODO (code4, "i(a,b,c,d=5,x=4,y", 4),
        // TODO (code4, "i(a,b,c,d=5,x=4,y=3,", 5),
        // TODO (code4, "i(a,b,c,d=5,y=4,x=3,", 5),
        // TODO (code4, "i(a,b,c,d=4,", 3),
        // TODO (code4, "i(a,b,c,x=1,d=,", 4),
        // Error nodes
        // TODO (code4, "i(1, [a,b", 1),
        (code4, "i(1, [a,b=,", 2),
        // TODO (code4, "i(1, [a?b,", 2),
        // TODO (code4, "i(1, [a?b,*", 2),
        // TODO (code4, "i(?b,*r,c", 1),
        // TODO (code4, "i(?*", 0),
        // TODO (code4, "i(?**", 1),
        // Random
        (code4, "i(()", 0),
