...
#? 49 ['a', 'foobar', "__annotate__", "__annotations__", "__dict__", "__doc__", "__file__", "__loader__", "__name__", "__package__", "__spec__"]
from import_tree.pkg.mod1 import not_existant,    # whitespace before
#? ['a', 'foobar', "__annotate__", "__annotations__", "__dict__", "__doc__", "__file__", "__loader__", "__name__", "__package__", "__spec__"]
from import_tree.pkg.mod1 import not_existant, 
#? ['a', 'foobar', "__annotate__", "__annotations__", "__dict__", "__doc__", "__file__", "__loader__", "__name__", "__package__", "__spec__"]
from import_tree.pkg.mod1 import not_existant,
#? 33 ['a', 'foobar', "__annotate__", "__annotations__", "__dict__", "__doc__", "__file__", "__loader__", "__name__", "__package__", "__spec__"]
from import_tree.pkg.mod1 import , not_existant
#? 36 ['foobar']
